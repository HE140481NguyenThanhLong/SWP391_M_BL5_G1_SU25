...
//        BigDecimal storePickup = BigDecimal.ZERO; // phí lấy tại cửa hàng
//        BigDecimal originalPrice = total.divide(new BigDecimal("1.08"), 2, RoundingMode.HALF_UP); // thuế

        BigDecimal originalPrice = BigDecimal.valueOf(order.getTotal());
        BigDecimal savings = BigDecimal.ZERO;
        BigDecimal storePickup = BigDecimal.ZERO;
        BigDecimal tax = originalPrice.multiply(new BigDecimal("0.08"));
        BigDecimal total = originalPrice.add(tax);
